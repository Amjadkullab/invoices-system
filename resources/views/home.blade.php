...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بك  </h2><br>
						  <h4 class="mg-b-0">نظام ادارة الفواتير</h4>
						</div>
					</div>
					...
					<div class="col-md-12 col-lg-12 col-xl-7">
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								...
								<p class="tx-12 text-muted mb-0">احصائيات جميع الفواتير بالتفصيل</p>
							</div>
