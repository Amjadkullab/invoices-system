...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @endcan
                <li class="side-item side-item-category">رفع فيديو خاص بالشركة</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon"
                            viewBox="0 0 24 24">
                        ...
                        </svg><span class="side-menu__label">خاص بالشركة</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'uploadpage')) }}">رفع فيديو</a></li>
