...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الشركة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ مشاهدة </span>
						</div>
					</div>
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                                        ...
                                        <?php $i++?>
                                            <tr>
                                                <td>{{ $i }}</td>
                                          <th><iframe src="/assets/{{ $data->file }}" frameborder="0"></iframe></th>
